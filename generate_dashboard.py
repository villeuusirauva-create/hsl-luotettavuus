...
<main>
    ...
    <div style="margin-bottom:28px;">
        ...
        <div style="display:flex;gap:12px;flex-wrap:wrap;">
            ...
            <a href="#" style="display:flex;align-items:center;gap:8px;background:#6b8caa;color:white;text-decoration:none;padding:10px 20px;border-radius:10px;font-weight:600;font-size:14px;opacity:0.6;cursor:default;">
